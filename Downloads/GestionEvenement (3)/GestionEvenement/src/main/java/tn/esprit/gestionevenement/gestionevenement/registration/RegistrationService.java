...
import tn.esprit.gestionevenement.gestionevenement.email.EmailSender;
import tn.esprit.gestionevenement.gestionevenement.entities.AppUserRole;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ...
        userServiceImp.enableUser(confirmationToken.getUser().getEmail());
        return "confirmed";
    }
